...
public class CiclistaControllerTest {
    ...
    public void testRecuperaCiclistaPorId() throws Exception{
        // Arrange
        int idCiclista = 1;
        when(ciclistaService.recuperaCiclistaPorId(idCiclista)).thenReturn(new Ciclista(new NovoCiclistaDTO("Luis Fumado", "01/01/2000", "123.456.789-00", new Passaporte("1","12/2025", "BR"), "Brasileiro", "luisfumado@gamil.com", "https://teste.com/foto.jpg")));

        String json = "{\"id\":1,\"status\":\"AGUARDANDO_CONFIRMACAO\",\"nome\":\"Luis Fumado\",\"nascimento\":\"01/01/2000\",\"cpf\":\"123.456.789-00\",\"passaporte\":{\"numero\":\"1\",\"validade\":\"12/2025\",\"pais\":\"BR\"},\"nacionalidade\":\"Brasileiro\",\"email\":\"luisfumado@gamil.com\",\"urlFotoDocumento\":\"https://teste.com/foto.jpg\",\"ativo\":false}";
    ...
    public void testCadastraCiclista() throws Exception {
        // Arrange
        NovoCiclistaDTO dadosCadastroCiclista = new NovoCiclistaDTO("Luis Fumado", "01/01/2000", "123.456.789-00", null, "Brasileiro", "luisfumado@gmail.com", "https://teste.com/foto.jpg");
        Ciclista ciclista = new Ciclista(dadosCadastroCiclista);
        when(ciclistaService.cadastraCiclista(dadosCadastroCiclista)).thenReturn(ciclista);
        ...
        String jsonEntrada = """
                ...
                """;
        String json = "{\"id\":1,\"status\":\"AGUARDANDO_CONFIRMACAO\",\"nome\":\"Luis Fumado\",\"nascimento\":\"01/01/2000\",\"cpf\":\"123.456.789-00\",\"passaporte\":null,\"nacionalidade\":\"Brasileiro\",\"email\":\"luisfumado@gmail.com\",\"urlFotoDocumento\":\"https://teste.com/foto.jpg\",\"ativo\":false}";
    ...
    public void testAtivaCiclista() throws Exception {
        // Arrange
        int idCiclista = 1;
        Ciclista ciclista = new Ciclista(new NovoCiclistaDTO("Luis Fumado", "01/01/2000", "123.456.789-00", new Passaporte("1","12/2025", "BR"), "Brasileiro", "luisfumado@gmail.com", "https://teste.com/foto.jpg"));
        ...
        String json = "{\"id\":1,\"status\":\"ATIVO\",\"nome\":\"Luis Fumado\",\"nascimento\":\"01/01/2000\",\"cpf\":\"123.456.789-00\",\"passaporte\":{\"numero\":\"1\",\"validade\":\"12/2025\",\"pais\":\"BR\"},\"nacionalidade\":\"Brasileiro\",\"email\":\"luisfumado@gmail.com\",\"urlFotoDocumento\":\"https://teste.com/foto.jpg\",\"ativo\":true}";
    ...
    public void testAlteraCiclista() throws Exception {
        // Arrange
        int idCiclista = 1;
        CiclistaDTO ciclistaDTO = new CiclistaDTO(1, "ATIVO", "Luis Fumado", "01/01/2000", "123.456.789-00", null, "Brasileiro", "luisfumado@gmail.com", "https://teste.com/foto.jpg");
        Ciclista ciclista = new Ciclista(new NovoCiclistaDTO("Luis Fumado", "01/01/2000", "123.456.789-00", new Passaporte("1","12/2025", "BR"), "Brasileiro", "luisfumado@gmail.com", "https://teste.com/foto.jpg"));
        ...
        String jsonEntrada = """
                ...
                """;
        String json = "{\"id\":1,\"status\":\"AGUARDANDO_CONFIRMACAO\",\"nome\":\"Luis Fumado\",\"nascimento\":\"01/01/2000\",\"cpf\":\"123.456.789-00\",\"passaporte\":{\"numero\":\"1\",\"validade\":\"12/2025\",\"pais\":\"BR\"},\"nacionalidade\":\"Brasileiro\",\"email\":\"luisfumado@gmail.com\",\"urlFotoDocumento\":\"https://teste.com/foto.jpg\",\"ativo\":false}";
