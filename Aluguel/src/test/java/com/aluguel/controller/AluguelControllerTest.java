...
class AluguelControllerTest {
    ...
    void registraAluguel() throws Exception {
        // Arrange
        when(ciclistaService.recuperaCiclistaPorId(1)).thenReturn(new Ciclista(new NovoCiclistaDTO("Luis Fumado", "01/01/2000", "123.456.789-00", new Passaporte("1","12/2025", "BR"), "Brasileiro", "luizfumado@gmail.com", "https://teste.com/foto.jpg")));
